...
parser.add_argument('--fun', type=str,
                    ...
                    help='Available functions: threshold, gauss-threshold, sobel-det,'
                         ' laplacian-det, candy-edge-det, face-rec',
                    required=True)
parser.add_argument('--x', type=int, choices=range(0, 640), required=True)
parser.add_argument('--y', type=int, choices=range(0, 480), required=True)
